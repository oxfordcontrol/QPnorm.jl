...
#@load string("/Users/nrontsis/OneDrive - The University of Oxford/PhD/Code/MarosMeszaros.jl/data/AUG3DQP.jld2") P q A b f0 
...
eTRS.solve_boundary(P, q, A, b, r, copy(x_init), printing_interval=100);
